/*
 * Copyright (C) 2026 AkashBoard Contributors
 *
 ...
 * keeps `applicationId = net.AkashPriyadarshii.dictate`, the old prefs file survives the in-place update and
...
class DictateLegacyPreferences(context: Context) {
    ...
    companion object {
        const val PREFS_NAME = "net.AkashPriyadarshii.dictate"
        private const val P = "net.AkashPriyadarshii.dictate."
