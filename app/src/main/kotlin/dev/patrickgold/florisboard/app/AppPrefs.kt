...
abstract class FlorisPreferenceModel : PreferenceModel() {
    ...
    inner class Dictate {
        ...
        // Accent color of the floating button (idle/transcribing visuals). Defaults to the AkashBoard electric violet.
        val floatingButtonColor = custom(
            key = "dictate__floating_button_color",
            default = Color(0xFF7C3AED),
    ...
    inner class Other {
        ...
        val accentColor = custom(
            ...
            default = Color(0xFF7C3AED), // AkashBoard electric violet
            serializer = ColorPreferenceSerializer,
        )
