...
Writes <out>/pinyin.sqlite3 and <out>/net.AkashPriyadarshii.dictate.pinyin.flex — the latter is what the app
...
EXTENSION_ID = "net.AkashPriyadarshii.dictate.pinyin"
TABLE = "pinyin"
...
def extension_manifest(version: str) -> dict:
    return {
        ...
        "meta": {
            ...
            "maintainers": ["AkashPriyadarshii <accounts@AkashPriyadarshii.net>"],
            "homepage": "https://github.com/AkashPriyadarshii/AkashBoard",
